...
Source0  : https://files.pythonhosted.org/packages/7c/dc/e5b3b31d6eab052a2fc14265faf836d361da0c6a1452c304db89c3262e97/azure-mgmt-compute-30.4.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-30.4.0
cd %{_builddir}/azure-mgmt-compute-30.4.0
pushd ..
cp -a azure-mgmt-compute-30.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702922857

...
Source0  : https://files.pythonhosted.org/packages/87/30/bb941f2eee419009668305b510dfb3577604a08102b3a1d0df78d14205f3/azure_mgmt_compute-34.1.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_compute-34.1.0
cd %{_builddir}/azure_mgmt_compute-34.1.0
pushd ..
cp -a azure_mgmt_compute-34.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742825307

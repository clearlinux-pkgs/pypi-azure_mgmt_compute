...
Source0  : https://files.pythonhosted.org/packages/cd/f2/69cdd710bd8171fb2a0b30749811eeb311f703e9af40d21fc91b13ec3d2a/azure-mgmt-compute-29.1.0.zip
...
%prep
%setup -q -n azure-mgmt-compute-29.1.0
cd %{_builddir}/azure-mgmt-compute-29.1.0
pushd ..
cp -a azure-mgmt-compute-29.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674055420

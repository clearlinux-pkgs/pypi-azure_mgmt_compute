...
Source0  : https://files.pythonhosted.org/packages/e4/db/f577c83b84bef1e741ff4b5ac9eadf5b8ab881ae3f3757338e71122384fc/azure-mgmt-compute-30.5.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-30.5.0
cd %{_builddir}/azure-mgmt-compute-30.5.0
pushd ..
cp -a azure-mgmt-compute-30.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705937064

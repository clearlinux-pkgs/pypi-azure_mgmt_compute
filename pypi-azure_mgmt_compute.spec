...
Source0  : https://files.pythonhosted.org/packages/a5/c7/353e3a9834f9fc470c1e9876278b216289fedfb07ffb713666e5aebb7e61/azure-mgmt-compute-31.0.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-31.0.0
cd %{_builddir}/azure-mgmt-compute-31.0.0
pushd ..
cp -a azure-mgmt-compute-31.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714059341

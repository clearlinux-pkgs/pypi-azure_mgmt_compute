...
Source0  : https://files.pythonhosted.org/packages/97/cf/38439aa5da4115b24d6fdd0f0985deca014025d2662d5432dc47fbbf5641/azure-mgmt-compute-25.0.0.zip
...
%prep
%setup -q -n azure-mgmt-compute-25.0.0
cd %{_builddir}/azure-mgmt-compute-25.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643386371
...
cp %{_builddir}/azure-mgmt-compute-25.0.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_mgmt_compute/7aea571d641549de89730da8e7ff5a6940c5526b

...
Source0  : https://files.pythonhosted.org/packages/27/33/977dd42411da5f6e1c6bedcd0ed7be647b83676a1bee29a09dcf4a6ed0a5/azure-mgmt-compute-32.0.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-32.0.0
cd %{_builddir}/azure-mgmt-compute-32.0.0
pushd ..
cp -a azure-mgmt-compute-32.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721921957

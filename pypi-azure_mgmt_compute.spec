...
Source0  : https://files.pythonhosted.org/packages/1e/e2/04dc4d1d2592858b7cf22efde3f7c5e5516faf98131214823b68fb7c087a/azure-mgmt-compute-30.6.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-30.6.0
cd %{_builddir}/azure-mgmt-compute-30.6.0
pushd ..
cp -a azure-mgmt-compute-30.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710538981

...
Source0  : https://files.pythonhosted.org/packages/90/f2/a2b1391e9df876d7ef9086f8d41ad4666eafef921ae0c47da931f8cedb1a/azure-mgmt-compute-33.0.0.tar.gz
...
%prep
%setup -q -n azure-mgmt-compute-33.0.0
cd %{_builddir}/azure-mgmt-compute-33.0.0
pushd ..
cp -a azure-mgmt-compute-33.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724410682

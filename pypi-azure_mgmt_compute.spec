...
Source0  : https://files.pythonhosted.org/packages/76/b4/0b5b7e7cce4e83efc59e9a0763d95c613edd0d87f17891d7cccb451ff071/azure_mgmt_compute-33.1.0.tar.gz
...
%prep
%setup -q -n azure_mgmt_compute-33.1.0
cd %{_builddir}/azure_mgmt_compute-33.1.0
pushd ..
cp -a azure_mgmt_compute-33.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735093769
